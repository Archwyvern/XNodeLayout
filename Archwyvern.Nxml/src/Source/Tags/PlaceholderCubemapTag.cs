...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "PlaceholderCubemap", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class PlaceholderCubemapTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemap.Layers")] public string _Surrogate_Element_Layers {
            get => Layers != null ? ((System.Int32)Layers).ToString() : "";
            set { if (value != "") { Layers = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemap.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemap.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemap.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.PlaceholderCubemap) return alt;
            var obj = (Godot.PlaceholderCubemap)alt ?? new Godot.PlaceholderCubemap();
