...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "CompressedTexture2D", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class CompressedTexture2DTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CompressedTexture2D.LoadPath")] public string _Surrogate_Element_LoadPath {
            get => LoadPath != null ? ((System.String)LoadPath).ToString() : "";
            set { if (value != "") { LoadPath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CompressedTexture2D.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CompressedTexture2D.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CompressedTexture2D.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.CompressedTexture2D) return alt;
            var obj = (Godot.CompressedTexture2D)alt ?? new Godot.CompressedTexture2D();
