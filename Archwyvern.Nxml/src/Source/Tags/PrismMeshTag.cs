...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "PrismMesh", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class PrismMeshTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        public static class ElementProperty
        {
            [System.Xml.Serialization.XmlType(TypeName = "PrismMesh.ElementProperty.Material")] public class Material
            {
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.Material")] public PrismMeshTag.ElementProperty.Material? _Surrogate_Element_Material;

        // Simple Attributes
        [System.Xml.Serialization.XmlAttribute(AttributeName = "LeftToRight")] public string _Surrogate_Attribute_LeftToRight {
            get => LeftToRight != null ? ((System.Single)LeftToRight).ToString() : "";
            set { if (value != "") { LeftToRight = System.Single.Parse(value); } }
        }
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.LeftToRight")] public string _Surrogate_Element_LeftToRight {
            get => LeftToRight != null ? ((System.Single)LeftToRight).ToString() : "";
            set { if (value != "") { LeftToRight = System.Single.Parse(value); } }
        }
        [System.Xml.Serialization.XmlIgnore] public System.Single? LeftToRight { get; set; }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.SubdivideWidth")] public string _Surrogate_Element_SubdivideWidth {
            get => SubdivideWidth != null ? ((System.Int32)SubdivideWidth).ToString() : "";
            set { if (value != "") { SubdivideWidth = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.SubdivideHeight")] public string _Surrogate_Element_SubdivideHeight {
            get => SubdivideHeight != null ? ((System.Int32)SubdivideHeight).ToString() : "";
            set { if (value != "") { SubdivideHeight = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.SubdivideDepth")] public string _Surrogate_Element_SubdivideDepth {
            get => SubdivideDepth != null ? ((System.Int32)SubdivideDepth).ToString() : "";
            set { if (value != "") { SubdivideDepth = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.FlipFaces")] public string _Surrogate_Element_FlipFaces {
            get => FlipFaces != null ? ((System.Boolean)FlipFaces).ToString() : "";
            set { if (value != "") { FlipFaces = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.AddUV2")] public string _Surrogate_Element_AddUV2 {
            get => AddUV2 != null ? ((System.Boolean)AddUV2).ToString() : "";
            set { if (value != "") { AddUV2 = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.UV2Padding")] public string _Surrogate_Element_UV2Padding {
            get => UV2Padding != null ? ((System.Single)UV2Padding).ToString() : "";
            set { if (value != "") { UV2Padding = System.Single.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PrismMesh.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.PrismMesh) return alt;
            var obj = (Godot.PrismMesh)alt ?? new Godot.PrismMesh();

            // Attributes
            if (LeftToRight != null) obj.LeftToRight = (System.Single)LeftToRight;
