...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "ConvexPolygonShape3D", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class ConvexPolygonShape3DTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ConvexPolygonShape3D.CustomSolverBias")] public string _Surrogate_Element_CustomSolverBias {
            get => CustomSolverBias != null ? ((System.Single)CustomSolverBias).ToString() : "";
            set { if (value != "") { CustomSolverBias = System.Single.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ConvexPolygonShape3D.Margin")] public string _Surrogate_Element_Margin {
            get => Margin != null ? ((System.Single)Margin).ToString() : "";
            set { if (value != "") { Margin = System.Single.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ConvexPolygonShape3D.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ConvexPolygonShape3D.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ConvexPolygonShape3D.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.ConvexPolygonShape3D) return alt;
            var obj = (Godot.ConvexPolygonShape3D)alt ?? new Godot.ConvexPolygonShape3D();
