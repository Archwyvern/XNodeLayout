...
namespace Archwyvern.Nxml.Tags
{
    ...
    public class TextureRectTag : Archwyvern.Nxml.Tag
    {
#nullable enable
        // Simple Fields
        [System.Xml.Serialization.XmlAttribute(AttributeName = "ExpandMode")] public string _Surrogate_ExpandMode {
            get => ExpandMode != null ? ((Godot.TextureRect.ExpandModeEnum)ExpandMode).ToString() : "";
            set => ExpandMode = value != "" ? System.Enum.Parse<Godot.TextureRect.ExpandModeEnum>(value) : null;
        }
        [System.Xml.Serialization.XmlIgnore] public Godot.TextureRect.ExpandModeEnum? ExpandMode;
        [System.Xml.Serialization.XmlAttribute(AttributeName = "StretchMode")] public string _Surrogate_StretchMode {
            ...
            set => StretchMode = value != "" ? System.Enum.Parse<Godot.TextureRect.StretchModeEnum>(value) : null;
        }
        [System.Xml.Serialization.XmlIgnore] public Godot.TextureRect.StretchModeEnum? StretchMode;
