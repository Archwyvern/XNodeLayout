...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "VideoStreamTheora", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class VideoStreamTheoraTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "VideoStreamTheora.File")] public string _Surrogate_Element_File {
            get => File != null ? ((System.String)File).ToString() : "";
            set { if (value != "") { File = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "VideoStreamTheora.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "VideoStreamTheora.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "VideoStreamTheora.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.VideoStreamTheora) return alt;
            var obj = (Godot.VideoStreamTheora)alt ?? new Godot.VideoStreamTheora();
