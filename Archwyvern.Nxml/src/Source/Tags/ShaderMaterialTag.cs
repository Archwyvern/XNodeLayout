...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "ShaderMaterial", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class ShaderMaterialTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        public static class ElementProperty
        {
            [System.Xml.Serialization.XmlType(TypeName = "ShaderMaterial.ElementProperty.Shader")] public class Shader
            {
                [System.Xml.Serialization.XmlElement(ElementName = "Shader", Type = typeof(ShaderTag))]
                [System.Xml.Serialization.XmlElement(ElementName = "VisualShader", Type = typeof(VisualShaderTag))]
                public Archwyvern.Nxml.BaseTag? Value;
            }

            [System.Xml.Serialization.XmlType(TypeName = "ShaderMaterial.ElementProperty.NextPass")] public class NextPass
            {
        ...
        [System.Xml.Serialization.XmlIgnore] public BaseTag? Shader => _Surrogate_Element_Shader?.Value;
        [System.Xml.Serialization.XmlElement(ElementName = "ShaderMaterial.Shader")] public ShaderMaterialTag.ElementProperty.Shader? _Surrogate_Element_Shader;

        [System.Xml.Serialization.XmlIgnore] public BaseTag? NextPass => _Surrogate_Element_NextPass?.Value;
        [System.Xml.Serialization.XmlElement(ElementName = "ShaderMaterial.NextPass")] public ShaderMaterialTag.ElementProperty.NextPass? _Surrogate_Element_NextPass;
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ShaderMaterial.RenderPriority")] public string _Surrogate_Element_RenderPriority {
            get => RenderPriority != null ? ((System.Int32)RenderPriority).ToString() : "";
            set { if (value != "") { RenderPriority = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ShaderMaterial.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ShaderMaterial.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "ShaderMaterial.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.ShaderMaterial) return alt;
            var obj = (Godot.ShaderMaterial)alt ?? new Godot.ShaderMaterial();
            ...
            // Elements
            if (Shader != null) {
                if (((IResourceTag)Shader).ResourcePath != null) {
                    obj.Shader = (Godot.Shader)Shader.Generate(Godot.GD.Load<Godot.Shader>(((IResourceTag)Shader).ResourcePath));
                } else {
                    obj.Shader = (Godot.Shader)Shader.Generate();
                }
            }
            if (NextPass != null) {
