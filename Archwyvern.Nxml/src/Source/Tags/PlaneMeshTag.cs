...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "PlaneMesh", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class PlaneMeshTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        public static class ElementProperty
        {
            [System.Xml.Serialization.XmlType(TypeName = "PlaneMesh.ElementProperty.Material")] public class Material
            {
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.Material")] public PlaneMeshTag.ElementProperty.Material? _Surrogate_Element_Material;
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.SubdivideWidth")] public string _Surrogate_Element_SubdivideWidth {
            get => SubdivideWidth != null ? ((System.Int32)SubdivideWidth).ToString() : "";
            set { if (value != "") { SubdivideWidth = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.SubdivideDepth")] public string _Surrogate_Element_SubdivideDepth {
            get => SubdivideDepth != null ? ((System.Int32)SubdivideDepth).ToString() : "";
            set { if (value != "") { SubdivideDepth = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.Orientation")] public string _Surrogate_Element_Orientation {
            get => Orientation != null ? ((Godot.PlaneMesh.OrientationEnum)Orientation).ToString() : "";
            set { if (value != "") { Orientation = System.Enum.Parse<Godot.PlaneMesh.OrientationEnum>(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.FlipFaces")] public string _Surrogate_Element_FlipFaces {
            get => FlipFaces != null ? ((System.Boolean)FlipFaces).ToString() : "";
            set { if (value != "") { FlipFaces = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.AddUV2")] public string _Surrogate_Element_AddUV2 {
            get => AddUV2 != null ? ((System.Boolean)AddUV2).ToString() : "";
            set { if (value != "") { AddUV2 = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.UV2Padding")] public string _Surrogate_Element_UV2Padding {
            get => UV2Padding != null ? ((System.Single)UV2Padding).ToString() : "";
            set { if (value != "") { UV2Padding = System.Single.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaneMesh.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.PlaneMesh) return alt;
            var obj = (Godot.PlaneMesh)alt ?? new Godot.PlaneMesh();
