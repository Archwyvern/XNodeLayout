...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "PlaceholderCubemapArray", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class PlaceholderCubemapArrayTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemapArray.Layers")] public string _Surrogate_Element_Layers {
            get => Layers != null ? ((System.Int32)Layers).ToString() : "";
            set { if (value != "") { Layers = System.Int32.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemapArray.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemapArray.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "PlaceholderCubemapArray.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.PlaceholderCubemapArray) return alt;
            var obj = (Godot.PlaceholderCubemapArray)alt ?? new Godot.PlaceholderCubemapArray();
