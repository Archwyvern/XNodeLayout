...
{
    [System.Xml.Serialization.XmlRoot(ElementName = "CapsuleShape2D", Namespace = "http://archwyvern.com/xsd/nxml")]
    public class CapsuleShape2DTag : Archwyvern.Nxml.BaseTag, Archwyvern.Nxml.IResourceTag
    {
#nullable enable
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CapsuleShape2D.Radius")] public string _Surrogate_Element_Radius {
            get => Radius != null ? ((System.Single)Radius).ToString() : "";
            set { if (value != "") { Radius = System.Single.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CapsuleShape2D.Height")] public string _Surrogate_Element_Height {
            get => Height != null ? ((System.Single)Height).ToString() : "";
            set { if (value != "") { Height = System.Single.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CapsuleShape2D.CustomSolverBias")] public string _Surrogate_Element_CustomSolverBias {
            get => CustomSolverBias != null ? ((System.Single)CustomSolverBias).ToString() : "";
            set { if (value != "") { CustomSolverBias = System.Single.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CapsuleShape2D.ResourceLocalToScene")] public string _Surrogate_Element_ResourceLocalToScene {
            get => ResourceLocalToScene != null ? ((System.Boolean)ResourceLocalToScene).ToString() : "";
            set { if (value != "") { ResourceLocalToScene = System.Boolean.Parse(value); } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CapsuleShape2D.ResourcePath")] public string _Surrogate_Element_ResourcePath {
            get => ResourcePath != null ? ((System.String)ResourcePath).ToString() : "";
            set { if (value != "") { ResourcePath = value; } }
        }
        ...
        [System.Xml.Serialization.XmlElement(ElementName = "CapsuleShape2D.ResourceName")] public string _Surrogate_Element_ResourceName {
            get => ResourceName != null ? ((System.String)ResourceName).ToString() : "";
            set { if (value != "") { ResourceName = value; } }
        }
...
#nullable disable
        ...
        {
            if (alt != null && alt is not Godot.CapsuleShape2D) return alt;
            var obj = (Godot.CapsuleShape2D)alt ?? new Godot.CapsuleShape2D();
