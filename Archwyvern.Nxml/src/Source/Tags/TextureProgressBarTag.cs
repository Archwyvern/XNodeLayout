...
#nullable disable
        ...
        [System.Xml.Serialization.XmlIgnore] public Archwyvern.Nxml.Translators.Vector2? TextureProgressOffset;
        [System.Xml.Serialization.XmlAttribute(AttributeName = "TintUnder")] public string _Surrogate_TintUnder {
            get => TintUnder != null ? ((Archwyvern.Nxml.Translators.Color)TintUnder).ToString() : "";
            set => TintUnder = value != "" ? value : null;
        }
        [System.Xml.Serialization.XmlIgnore] public Archwyvern.Nxml.Translators.Color? TintUnder;
        [System.Xml.Serialization.XmlAttribute(AttributeName = "TintOver")] public string _Surrogate_TintOver {
            get => TintOver != null ? ((Archwyvern.Nxml.Translators.Color)TintOver).ToString() : "";
            set => TintOver = value != "" ? value : null;
        }
        [System.Xml.Serialization.XmlIgnore] public Archwyvern.Nxml.Translators.Color? TintOver;
        [System.Xml.Serialization.XmlAttribute(AttributeName = "TintProgress")] public string _Surrogate_TintProgress {
            get => TintProgress != null ? ((Archwyvern.Nxml.Translators.Color)TintProgress).ToString() : "";
            set => TintProgress = value != "" ? value : null;
        }
        [System.Xml.Serialization.XmlIgnore] public Archwyvern.Nxml.Translators.Color? TintProgress;
        [System.Xml.Serialization.XmlAttribute(AttributeName = "RadialCenterOffset")] public string _Surrogate_RadialCenterOffset {
            get => RadialCenterOffset != null ? ((Archwyvern.Nxml.Translators.Vector2)RadialCenterOffset).ToString() : "";
            set => RadialCenterOffset = value != "" ? value : null;
        }
        [System.Xml.Serialization.XmlIgnore] public Archwyvern.Nxml.Translators.Vector2? RadialCenterOffset;
        ...
        public override Godot.Node CreateNode()
        {
            ...
            if (StretchMarginTop != null) obj.StretchMarginTop = (System.Int32)StretchMarginTop;
            if (StretchMarginRight != null) obj.StretchMarginRight = (System.Int32)StretchMarginRight;
            if (StretchMarginBottom != null) obj.StretchMarginBottom = (System.Int32)StretchMarginBottom;
            if (RadialInitialAngle != null) obj.RadialInitialAngle = (System.Single)RadialInitialAngle;
            if (RadialFillDegrees != null) obj.RadialFillDegrees = (System.Single)RadialFillDegrees;
            ...
            if (TintProgress != null) obj.TintProgress = (Archwyvern.Nxml.Translators.Color)TintProgress;
            if (RadialCenterOffset != null) obj.RadialCenterOffset = (Archwyvern.Nxml.Translators.Vector2)RadialCenterOffset;
